...
build_time_vars = {
    ...
    "ALT_SOABI": 0,
    "ANDROID_API_LEVEL": 0,
    "AR": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    "BASECFLAGS": "",
    "BASECPPFLAGS": "",
    "BASEMODLIBS": "",
    ...
    "CONFIG_ARGS": "'--build=aarch64-apple-darwin' '--host=aarch64-apple-darwin' '--prefix=/install' '--with-openssl=/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/deps' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--enable-shared' '--enable-optimizations' '--with-lto' '--with-build-python=/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/host/bin/python3.11' 'ac_cv_lib_intl_textdomain=no' 'ac_cv_func_ptsname_r=no' '--with-dbmliborder=ndbm' 'build_alias=aarch64-apple-darwin' 'host_alias=aarch64-apple-darwin' 'PKG_CONFIG=pkg-config --static' 'PKG_CONFIG_PATH=/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/deps/share/pkgconfig:/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/deps/lib/pkgconfig' 'CC=clang' 'CFLAGS=-O3 -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'LDFLAGS=-arch arm64 -mmacosx-version-min=11.0   -Wl,-headerpad,40' 'CPPFLAGS=-O3 -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'PROFILE_TASK=-m test --pgo -j 7'",
    "CONFINCLUDEDIR": "/install/include",
    "CONFINCLUDEPY": "/install/include/python3.11",
    "COREPYTHONPATH": "",
    "COVERAGE_INFO": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15/coverage.info",
    "COVERAGE_LCOV_OPTIONS": "--rc lcov_branch_coverage=1",
    "COVERAGE_REPORT": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15/lcov-report",
    ...
    "FREEZE_MODULE": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/host/bin/python3.11 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/host/bin/python3.11 ./Programs/_freeze_module.py",
    ...
    "LLVM_PROFDATA": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/llvm/bin/llvm-profdata",
    "LLVM_PROF_ERR": "no",
    "LLVM_PROF_FILE": "LLVM_PROFILE_FILE=\"code-%128m.profclangr\"",
    "LLVM_PROF_MERGER": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/llvm/bin/llvm-profdata merge -output=code.profclangd *.profclangr",
    "LN": "ln",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/host/bin/python3.11",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/host/bin/python3.11",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    ...
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "DYLD_LIBRARY_PATH=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15 _PYTHON_PROJECT_BASE=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/host/bin/python3.11",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "DYLD_LIBRARY_PATH=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15 _PYTHON_PROJECT_BASE=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/tools/host/bin/python3.11 ./Tools/scripts/run_tests.py",
    ...
    "abs_builddir": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15",
    "abs_srcdir": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmp36vcoqge/Python-3.11.15",
